 ...
 */ const vi = Se("WandSparkles", [
  ...
  cC = "v1.5.14-gemini-base64fix-v4",
  ...
  Xl = [
    ...
    { id: ff, name: "自定义 OpenAI兼容 API", baseUrl: "", apiKey: "" },
  ],
  tn = {
    platforms: Xl,
    activePlatformId: Wl,
  ...
  return (
    ...
    e.forEach((n) => {
      ...
      if (String(n.id || "") === Wl || /comfly/i.test(String(n.name || ""))) {
        const o = Xl.find((i) => i.id === Wl);
        r = { ...r, id: Wl, name: o.name, baseUrl: o.baseUrl };
      }
      t.set(r.id, r);
    }),
    Array.from(t.values())
...
function Hn(e) {
  ...
  return /(^|\.)ai\.comfly\.chat/i.test(String(e || ""));
}
function sy(e) {
...
function RC(e, t) {
  const n = {
    ...
    [o, i] = n[e] || n["1:1"];
  return `${Math.round(o * r)}x${Math.round(i * r)}`;
}
function gf(e) {
  return e && e !== "自适应" ? e : "";
}
...
async function buildGeminiImageBody({ model: e, prompt: t, ratio: n, quality: r, images: o = [] }) {
  const i = [{ text: t }],
    s = await buildGeminiImageParts(o);
  s.forEach((l) => {
    i.push({ inline_data: { mime_type: l.mimeType, data: l.data } });
  });
  const l = {
  ...
  const a = gf(n);
  a && (l.generationConfig.aspectRatio = a);
  const u = qn(r || "1k");
  u && (l.generationConfig.imageSize = u);
  return l;
}
...
function Kl(e, t) {
  ...
  return ((o = e == null ? void 0 : e.platforms) != null && o.length
    ...
    ? t
    : (e == null ? void 0 : e.activePlatformId) || Wl;
}
function kt(e, t = "") {
  return VM(e);
}
    ...
    children: t.map((s) => {
      ...
      return m.jsx(
        "button",
        {
          ...
          className: d ? "active" : "",
          onClick: (c) => {
            (c.stopPropagation(), r(l), o == null || o());
          },
          children:
            e === "model"
...
function aM({ id: e, data: t, selected: n }) {
  const [r, o] = z.useState(null),
    ...
    c = (f) => {
      ...
      (x = t.updateNode) == null ||
        x.call(t, e, { platformId: f, model: kt(p).includes(y) ? y : gr(p) });
    };
  return m.jsxs(Ai, {
    title: t.title || "图片生成",
    icon: fl,
      ...
      m.jsx("textarea", {
        ...
        onChange: (f) => {
          ...
          return (p = t.updateNode) == null
            ? void 0
            : p.call(t, e, { prompt: f.target.value });
        },
      }),
      m.jsxs("div", {
    ...
    ? m.jsxs("div", {
        ...
        children: [
          ...
          m.jsxs("button", {
            type: "button",
            onClick: () => t("imageNode"),
            children: [m.jsx(ty, { size: 15 }), " 图片节点"],
          }),
          m.jsxs("button", {
            type: "button",
            onClick: () => t("generateNode"),
            children: [m.jsx(fl, { size: 15 }), " 图片生成节点"],
          }),
          m.jsxs("button", {
            type: "button",
            onClick: () => t("angleNode"),
            children: [m.jsx(fl, { size: 15 }), " 多角度节点"],
          }),
          m.jsxs("button", {
            type: "button",
            onClick: () => t("upscaleNode"),
            children: [m.jsx(fl, { size: 15 }), " 高清放大节点"],
          }),
          m.jsxs("button", {
            type: "button",
            onClick: () => t("reverseNode"),
            children: [m.jsx(vi, { size: 15 }), " 反推提示词节点"],
          }),
          m.jsxs("button", {
            type: "button",
            onClick: () => t("textNode"),
            children: [m.jsx(J0, { size: 15 }), " 文本节点"],
          }),
          m.jsx("button", {
            type: "button",
            className: "ghost",
      ...
      async (O, B = "图片.png") => {
        try {
          const U = (B || "图片.png").replace(/[\\/:*?"<>|]/g, "-"),
            V = /\.(png|jpe?g|webp|gif)$/i.test(U) ? U : `${U}.png`;
          let W = O,
            J = "";
          try {
            if (!uo(O)) {
              const Q = await fetch(O, { mode: "cors" });
              Q.ok && ((J = URL.createObjectURL(await Q.blob())), (W = J));
            }
          } catch {}
          ...
          ((le.href = W),
            ...
            le.click(),
            le.remove(),
            J && setTimeout(() => URL.revokeObjectURL(J), 500),
            k("图片已开始下载到本地。", "success"));
        } catch (U) {
          k(`下载失败：${U.message}`, "error");
        }
      },
      [k],
    ),
...
`),
  ...
  (z.useEffect(() => {
    o((O) => {
      ...
      const U = O.map((V) => {
        if (
          !["generateNode", "upscaleNode", "reverseNode", "angleNode"].includes(
            V.type,
          )
        )
          return V;
  ...
  const I = z.useCallback(
    ...
    H = z.useCallback(
      async (O) => {
        ...
        await I(V, U, "这个分组里没有可运行的图片生成、高清放大或反推节点。");
      },
      [e, I],
    ),
    b = z.useRef(H);
        ...
        children: [
          ...
          m.jsxs("div", {
            ...
            children: [
              ...
              m.jsx("span", { children: "V1.5.14-gemini-base64fix-v4" }),
            ],
          }),
        ],
      }),
