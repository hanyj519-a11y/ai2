...
补丁说明 sizefix-v5
- 修复 Gemini / nano-banana 选择 4K 但实际输出 1K 的问题。
- generateContent 请求体同时传 image_size、imageSize、image_config、imageConfig、generation_config、generationConfig 等多种字段，兼容不同第三方网关。
- 提示词中同步追加 2K/3K/4K 输出要求，防止网关忽略参数后默认 1K。
- 历史记录仍然只手动保存。
