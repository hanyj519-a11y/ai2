        ...
        <div className="settings-grid">
          ...
          <div className="settings-form">
            ...
            <div className="notice-box">
              <b>怎么填：</b>已内置 <code>https://ai.comfly.chat/v1</code>，只需要给 Comfly API 填你的密钥。API 密钥只保存在你的浏览器 localStorage。当前版本路由规则：<code>gpt-image-2</code> 无参考图走 <code>/v1/images/generations</code>，有参考图或高清放大走 <code>/v1/images/edits</code>；Comfly 侧使用默认 <code>default</code> 分组即可；<code>gemini-3.1-flash-image-preview</code> 和 <code>nano-banana-pro-4k</code> 走 <code>/v1/chat/completions</code>；反推提示词默认使用 Gemini 优质文本模型 <code>gemini-3.1-pro-preview</code>。多张图片会并行发送请求。
            </div>
          </div>
        </div>
      </div>
